...
| `BROWSER_CDP_URL` | Chrome DevTools Protocol URL for local browser (set via `/browser connect`, e.g. `ws://localhost:9222` on native Windows or `ws://localhost:9223` on WSL2) |
