...
> This repository is a custom Hermes fork tuned for cross-platform development. In this fork, native Windows is supported without requiring WSL, the browser sidecar and full-page control room are first-class operator surfaces, and Windows local shell auto-selection prefers `cmd.exe`, then PowerShell, then WSL.
...
Native Windows is supported for day-to-day use and development in this fork. WSL is optional, not required.
